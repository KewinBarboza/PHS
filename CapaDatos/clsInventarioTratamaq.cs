...
namespace CapaDatos
{
    public class clsInventarioTratamaq
    {
        ...
        public DataTable consultarInventarioTratamaq(string movimiento, string material, string fechaDesde, string fechaHasta, int opc)
        {
            comando.Connection=conexion.AbrirConexion();
            comando.CommandText="consultarInventarioTratamaq";
